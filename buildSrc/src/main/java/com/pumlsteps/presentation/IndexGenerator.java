...
<head>
    ...
    <title>MADs Presentations</title>
...
""";
    ...
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-diagram-project"></i> MADS Presentations</h1>
            <p>Interactive presentations for understanding distributed systems concepts</p>
        </div>
